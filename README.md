...
3. **Testing Roles (Important Note):** 
   ...
   *Use email: [admin@gmail.com] and password:admin@gmail.co for both roles, just switch between them by logging out and logging in with the same email and password. 
